...
public class PetMain 
{
    public static void main( String[] args )
    {
        ...
        Dog myDog = new Dog("long", "short", "pointed", "Daisy", 3, "Dog", 2.8, "Female", "Black", "Yorkie", "Tori", "stuffed duck");
        System.out.println("Dog 1: " + myDog.toString());
        Dog myDog2 = new Dog ("short", "short", "folded", "Sissy", 16, "Dog", 15, "Female", "White", "Jack Russell", "Ryan", "plush snake");
        System.out.println("Dog 2: " + myDog2.toString());
        Dog myDog3 = new Dog("short", "long", "floppy", "Molly" , 6, "Dog", 16.3, "Female", "Brown", "Beagle", "Jake", "ball");
        ...
        Cat myCat2 = new Cat("calico", "long", "Caramel", 4, "Cat", 8, "Female", "White", "Persian", "Jane", "squeaky rat");
        System.out.println("Cat 2: " + myCat2.toString());
        Cat myCat3 = new Cat("solid", "short", "Merlin", 6, "Cat", 12, "Male", "Grey", "Siamese", "Tom", "feather stick");
        ...
        Fish myFish = new Fish(5, "fresh", 1.7, "Goldie", 1, "Fish", 0.5, "Female", "Gold", "Goldfish", "Sally", "ring");
        System.out.println("Fish 1: " + myFish.toString());
        Fish myFish2 = new Fish(7, "fresh", 2.5, "Spike", 2, "Fish", 0.65, "Male", "Red", "Betta", "Xander", "plastic plant");
